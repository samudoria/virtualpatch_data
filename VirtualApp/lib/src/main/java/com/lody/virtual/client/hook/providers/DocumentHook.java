...
public class DocumentHook extends ProviderHook {
    private interface DocumentsContract {
        ...
        String METHOD_GET_DOCUMENT_METADATA = "android:getDocumentMetadata";
    }
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (name.equals("query") || name.equals("openTypedAssetFile") || name.equals("openAssetFile")) {
            ...
            if (methodName.equals(DocumentsContract.METHOD_GET_DOCUMENT_METADATA)) {
                checkDocumentMetadataPermission();
            }
    ...
    private void checkDocumentMetadataPermission() throws Throwable {
        Log.d("sime_meta", "getDocumentMetadata called");
        ...
        Log.d("sime_meta", "getPersistedUriPermissions: " + getPersistedUriPermissions.toString());
        // host package because the provider is external, i.e. any persisted permission is granted to the host package
        Object res = getPersistedUriPermissions.invoke(ams, VirtualCore.getConfig().getHostPackageName(), true);
